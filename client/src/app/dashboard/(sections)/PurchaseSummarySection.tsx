...
function PurchaseSummarySection() {
	...
	if (error || !dashboardMetrics)
		return <section>Error fetching Purchase Summary.</section>;

	const lastDataPoint = purchaseSummary[purchaseSummary.length - 1] || null;

	return (
		<section className="flex flex-col justify-between row-span-2 xl:row-span-3 col-span-1 md:col-span-2 xl:col-span-1 bg-gray-50 shadow-md rounded-2xl">
			{isLoading ? (
